...
public class UrlParamGenarete {
     ...
     * @return
     */
    public static String urlParamByMap(Map<Object,Object> param,boolean add_w,boolean isEncode){
            ...
            if(count==0) {
                try {
                    if(o instanceof String) {
                        urlParam = urlParam + key + "=" + (isEncode?URLEncoder.encode((String) o, "UTF-8"):(String)o);
                    }else {
